...
/***********************************************************************/
    ...
    public void init(){
        ...
        r=0;
        widerstand = new Widerstand();
        widerstand.startWiderstand(0.01);
        widerstand.Settoeffnen(10);
        widerstand.Settoffen(15);
    }
    ...
    public double[] w (double t, double[] z)
    {
        ...
        double[]res = new double[4];//5er array, störgrössen abspeichern
        
        /** Systemgrössen **/   
        double g = 10;        // Gravitations Beschleunigung
        
        r=widerstand.calcWiderstand(t);
	
        /** Einflussgrössen **/
        /** Funktion wind **/   
             
        /** Hilfssgrössen **/
        /** u = Geschwindigkeit Ball gegenüber bewegter Luft **/     
        ...
        /** Berechnung derAbleitungen der Zustandsgrössen **/
        res[0] =  z[2];
        res[1] =  z[3];
    ...
    { 
    	...
    	//je nach Höhe wird ein anderer Wind gesetzt
    	if(yKO>500 && yKO<1000){
...
/***********************************************************************/
    ...
    /** erstellen einer Wertetabelle  y=f(t) für die
    ...
    /** erstellen einer Wertetabelle t --> y=f(t) 
        mit einer gleichabständigen Tabelle t[] = {t0, t1, ... tn} 
